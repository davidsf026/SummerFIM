...
class MainOperations:
    ...
    def init(pathToScan = SettingsYamlVars.pathToScan, filesListWithHashesTextFilePath = SettingsYamlVars.filesListWithHashesTextFilePath):
    ...
    def update(pathToScan = SettingsYamlVars.pathToScan, filesListWithHashesTextFilePath = SettingsYamlVars.filesListWithHashesTextFilePath):
